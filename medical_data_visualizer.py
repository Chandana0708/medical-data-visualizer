...
df["cholestorol"] = df["cholestorol"].apply(lambda x: 0 if x==1 else 1)
...
def draw_cat_plot():
    ...
    df_cat = pd.melt(df,id_vars =["cardio"], value_vars =["'cholesterol', 'gluc', 'smoke', 'alco', 'active', and 'overweight'"])
